...
export class BlogView {
  ...
  /* Відображення постів */
  renderPosts(posts, currentPage = 1, postsPerPage = 2) 
  {
    ...
    currentPosts.forEach(post => 
    {
      ...
      const authorName = author ? `${author.surname} ${author.name}` : 'Невідомий';
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start">
            <div class="flex-shrink-0">
              <img src="img/avatar.png" class="rounded-circle" width="80" height="80" alt="User Avatar">
            </div>
            <div class="flex-grow-1 ms-3">
              ...
              <div class="collapse mt-3" id="comments${post.id}">
                ${post.comments.map(comment => 
                {
                  ...
                  const commentAuthorName = commentAuthor ? `${commentAuthor.surname} ${commentAuthor.name}` : 'Невідомий';
                  return `
                    <div class="d-flex mb-2">
                      <div class="flex-shrink-0">
                        <img src="img/avatar.png" class="rounded-circle" width="60" height="60" alt="User Avatar">
                      </div>
                      <div class="flex-grow-1 ms-3">
  ...
  renderPagination(totalPages, currentPage) 
  {
    ...
    /* Завжди показуємо хоча б одну сторінку, навіть якщо постів немає */
